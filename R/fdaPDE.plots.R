...
#' @param ... Arguments representing graphical options to be passed to \link[graphics]{par}.
#' @description Plot the triangulation of a mesh MESH2D object, generated by \code{create.MESH.2.5D} or \code{second.order.MESH.2.5D}. The points indicates the mesh nodes.
#' @examples
